const PrivacyPolicyContent = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Punchcode Studios, 8812 NW 81st Ter.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to punchcodestudios, accessible from{" "}
            <a
      ...
      <ul>
        <li>
          <p>By email: admin@punchcodestudios.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.puchcodestudios.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
