        ...
        <div className="flex flex-col mx-auto p-6 pb-0">
          <div className="mx-auto min-h-[50px] max-w-[90%] lg:max-w-[70%]">
            <div className="xl:flex">
              <p className="font-text text-siteBlack">
                Last updated: December 30, 2024
              </p>
            </div>
          </div>
        </div>
        {/* https://www.termsfeed.com/live/9aaea4fe-fb1e-498c-aa86-2aa274d91654 */}
        <div className="mx-auto max-w-[90%] overflow-hidden 2xl-max-w-[70%]">
          <div className="mx-auto w-[80%] text-center xl:text-left">
          ...
          <article className="mt-10 pb-10 border-b-2 border-siteBlack">
            <h2 className="font-header font-bold text-secondary">
              Interpretation and Definitions
            </h2>
            <div className="mx-3">
              <h3 className="font-header">Interpretation</h3>
              ...
              <h3 className="font-header">Definitions</h3>
              <p className="font-text">
                For the purposes of this Privacy Policy:
              </p>
              <ul className="font-text ms-3">
                <li>
                  <p className="font-text">
                ...
                <li>
                  <p className="font-text">
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Punchcode
                    Studios, 8812 NW 81st Ter.
                  </p>
                </li>
                <li>
                  <p className="font-text">
                ...
                <li>
                  <p className="font-text">
                    <strong>Website</strong> refers to punchcodestudios,
                    accessible from{" "}
                    <a
                      href="https://www.punchcodestudios.com"
          ...
          <article className="mt-10 pb-10 border-b-2 border-siteBlack">
            ...
            <div className="mx-3">
              <h3 className="font-header">Types of Data Collected</h3>
              <h4>Personal Data</h4>
              <p className="font-text">
              ...
              <ul className="font-text ms-3 mb-5">
                <li>
                  <p className="font-text">Email address</p>
                </li>
                <li>
                  <p className="font-text">First name and last name</p>
                </li>
                <li>
                  <p className="font-text">Phone number</p>
                </li>
                <li>
                  <p className="font-text">
                ...
                <li>
                  <p className="font-text">Usage Data</p>
                </li>
              </ul>
              <h4>Usage Data</h4>
              <p className="font-text">
              ...
              <ul className="font-text ms-3 list-disc list-inside mb-5">
                <li>Google</li>
                <li>Facebook</li>
                <li>Instagram</li>
                <li>Twitter</li>
              ...
              <p className="font-text ms-3 mt-2">
              ...
              <p className="font-text ms-3 my-2">
              ...
              <ul className="font-text ms-3">
                <li>
                  ...
                  <div className="ms-3 mb-2">
                    <p className="font-text">Type: Session Cookies</p>
                    <p className="font-text">Administered by: Us</p>
                    <p className="font-text">
                ...
                <li>
                  ...
                  <div className="ms-3 mb-2">
                    <p className="font-text">Type: Persistent Cookies</p>
                    <p className="font-text">Administered by: Us</p>
                    <p className="font-text">
              ...
              <p className="font-text ms-3 mb-5">
                For more information about the cookies we use and your choices
                regarding cookies, please visit our Cookies Policy or the
                Cookies section of our Privacy Policy.
              </p>
              <h3 className="font-header">Use of Your Personal Data</h3>
              <p className="font-text">
              ...
              <div className="ms-3 mb-5">
                ...
                <ul className="font-text ms-3 list-disc list-inside">
                  <li>
              ...
              <div className="mt-5">
                <h3 className="font-header">Retention of Your Personal Data</h3>
                <p className="font-text">
              ...
              <div className="mt-5">
                <h3 className="font-header">Transfer of Your Personal Data</h3>
                <p className="font-text">
              ...
              <div className="mt-5">
                <h3 className="font-header">Delete Your Personal Data</h3>
                <p className="font-text">
              ...
              <h3 className="font-header">Disclosure of Your Personal Data</h3>
            ...
            <div className="ms-3 mt-5">
              <h3 className="font-header">Security of Your Personal Data</h3>
              <p className="font-text">
          ...
          <article className="mt-10 pb-10 border-b-2 border-siteBlack">
            <div className="mt-5">
              ...
              <div className="ms-3 mt-5">
                ...
                <h3 className="font-header mt-3">Email Marketing</h3>
                <p className="font-text">
          ...
          <article className="mt-10 pb-10 border-b-2 border-siteBlack">
            <h2 className="font-header font-bold text-secondary">Contact Us</h2>
            <div className="ms-3">
              <p className="font-text">
              ...
              <ul className="font-text ms-3 list-disc list-inside">
                <li>By email: admin@punchcodestudios.com</li>
                <li>
                  By visiting this page on our website:{" "}
                  <Link to="/contact">
                    https://www.puchcodestudios.com/contact
                  </Link>
                </li>
              </ul>
            </div>
