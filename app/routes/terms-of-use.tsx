  ...
  return (
    <>
      <section className="mb-20">
        ...
        <div className="mx-auto max-w-[90%] overflow-hidden 2xl-max-w-[70%]">
          <p className="font-text mb-3">
            Welcome to https://www.punchcodestudios.com. The
            https://www.punchcodestudios.com website (the "Site") is comprised
            of various web pages operated by Punchcode Studios ("punchcode
            studios"). https://www.punchcodestudios.com is offered to you
            ...
            https://www.punchcodestudios.com constitutes your agreement to all
            such Terms. Please read these terms carefully, and keep a copy of
            them for your reference.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>
              https://www.punchcodestudios.com is a portfolio Site.
            </strong>{" "}
            The purpose of this website is to demonstrate competencies in
            website design, provide online access to personal resume and
            examples of various technological achievements
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Privacy:</strong> Your use of
            https://www.punchcodestudios.com is subject to punchcode studios's{" "}
          ...
          <p className="font-text mb-3">
            <strong>Electronic Communications:</strong> Visiting
            https://www.punchcodestudios.com or sending emails to punchcode
            studios constitutes electronic communications. You consent to
          ...
          <p className="font-text mb-3">
            <strong>Your Account:</strong> If you use this site, you are
            ...
            punchcode studios is not responsible for third party access to your
            account that results from theft or misappropriation of your account.
            punchcode studios and its associates reserve the right to refuse or
            cancel service, terminate accounts, or remove or edit content in our
            sole discretion.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Children Under Thirteen:</strong> punchcode studios does not
            knowingly collect, either online or offline, personal information
            from persons under the age of thirteen. If you are under 18, you may
            use https://www.punchcodestudios.com only with permission of a
            parent or guardian.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Links to Third Party Sites/Third Party Services:</strong>
            https://www.punchcodestudios.com may contain links to other websites
            ("Linked Sites"). The Linked Sites are not under the control of
            punchcode studios and punchcode studios is not responsible for the
            ...
            Site. punchcode studios is providing these links to you only as a
            convenience, and the inclusion of any link does not imply
            endorsement by punchcode studios of the site or any association with
            its operators.
          </p>{" "}
          <p className="font-text mb-3">
            Certain services made available via https://www.punchcodestudios.com
            are delivered by third party sites and organizations. By using any
            product, service or functionality originating from the
            https://www.punchcodestudios.com domain, you hereby acknowledge and
            consent that punchcode studios may share such information and data
            with any third party with whom punchcode studios has a contractual
            relationship to provide the requested product, service or
            functionality on behalf of https://www.punchcodestudios.com users
            and customers.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>
            ...
            to access and use https://www.punchcodestudios.com strictly in
            accordance with these terms of use. As a condition of your use of
            the Site, you warrant to punchcode studios that you will not use the
          ...
          <p className="font-text mb-3">
            ...
            used on the Site, is the property of punchcode studios or its
          ...
          <p className="font-text mb-3">
            ...
            the Site. punchcode studios content is not for resale. Your use of
            ...
            permission of punchcode studios and the copyright owner. You agree
            ...
            the intellectual property of punchcode studios or our licensors
            except as expressly authorized by these Terms.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Third Party Accounts:</strong> You will be able to connect
            your punchcode studios account to third party accounts. By
            connecting your punchcode studios account to your third party
          ...
          <p className="font-text mb-3">
            <strong>International Users:</strong> The Service is controlled,
            operated and administered by punchcode studios from our offices
            within the USA. If you access the Service from a location outside
            the USA, you are responsible for compliance with all local laws. You
            agree that you will not use the punchcode studios Content accessed
            through https://www.punchcodestudios.com in any country or in any
            manner prohibited by any applicable laws, restrictions or
            regulations.   Indemnification You agree to indemnify, defend and
            hold harmless punchcode studios, its officers, directors, employees,
            ...
            arising out of your use of or inability to use the Site or services,
            any user postings made by you, your violation of any terms of this
            Agreement or your violation of any rights of a third party, or your
            violation of any applicable laws, rules or regulations. punchcode
            studios reserves the right, at its own cost, to assume the exclusive
            ...
            punchcode studios in asserting any available defenses.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Arbitration:</strong> In the event the parties are not able
            to resolve any dispute between them arising out of or concerning
            these Terms and Conditions, or any provisions hereof, whether in
            contract, tort, or otherwise at law or in equity for damages or any
            other relief, then such dispute shall be resolved only by final and
            ...
            parties. The arbitrator's award shall be final, and judgment may be
            entered upon it in any court having jurisdiction. In the event that
            any legal or equitable action, proceeding or arbitration arises out
            of or concerns these Terms and Conditions, the prevailing party
            shall be entitled to recover its costs and reasonable attorney's
            fees. The parties agree to arbitrate all disputes and claims in
            regards to these Terms and Conditions or any disputes arising as a
            result of these Terms and Conditions, whether directly or
            indirectly, including Tort claims that are a result of these Terms
          ...
          <p className="font-text mb-3">
            <strong>Class Action Waiver:</strong> Any arbitration under these
            Terms and Conditions will take place on an individual basis; class
            arbitrations and class/representative/collective actions are not
            permitted. THE PARTIES AGREE THAT A PARTY MAY BRING CLAIMS AGAINST
            ...
            punchcode studios agree otherwise, the arbitrator may not
            consolidate more than one person's claims, and may not otherwise
            preside over any form of a representative or class proceeding.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Liability Disclaimer:</strong> THE INFORMATION, SOFTWARE,
            ...
            PERIODICALLY ADDED TO THE INFORMATION HEREIN. PUNCHCODE STUDIOS
            AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE
            SITE AT ANY TIME.
          </p>{" "}
          <p className="font-text mb-3">
            PUNCHCODE STUDIOS AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT
            ...
            WARRANTY OR CONDITION OF ANY KIND. PUNCHCODE STUDIOS AND/OR ITS
          ...
          <p className="font-text mb-3">
            ...
            PUNCHCODE STUDIOS AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            PUNCHCODE STUDIOS OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
          ...
          <p className="font-text mb-3">
            <strong>Termination/Access Restriction:</strong> punchcode studios
            reserves the right, in its sole discretion, to terminate your access
            to the Site and the related services or any portion thereof at any
            time, without notice. To the maximum extent permitted by law, this
            agreement is governed by the laws of the State of Missouri and you
            hereby consent to the exclusive jurisdiction and venue of courts in
            Missouri in all disputes arising out of or relating to the use of
          ...
          <p className="font-text mb-3">
            ...
            relationship exists between you and punchcode studios as a result of
            this agreement or use of the Site. punchcode studios's performance
            of this agreement is subject to existing laws and legal process, and
            nothing contained in this agreement is in derogation of punchcode
            studios's right to comply with governmental, court and law
            enforcement requests or requirements relating to your use of the
            Site or information provided to or gathered by punchcode studios
          ...
          <p className="font-text mb-3">
            ...
            entire agreement between the user and punchcode studios with respect
            ...
            between the user and punchcode studios with respect to the Site. A
          ...
          <p className="font-text mb-3">
            <strong>Changes to Terms:</strong> punchcode studios reserves the
            right, in its sole discretion, to change the Terms under which
            https://www.punchcodestudios.com is offered. The most current
            version of the Terms will supersede all previous versions. punchcode
            studios encourages you to periodically review the Terms to stay
            informed of our updates.
          </p>{" "}
          <p className="font-text mb-3">
            <strong>Contact Us:</strong> punchcode studios welcomes your
            questions or comments regarding the Terms:
          </p>{" "}
          <div className="flex flex-col">
            <p className="font-text mb-3">
              Email us directly at admin@punchcodestudios.com
            </p>{" "}
            <p className="font-text mb-3">
              or reach us through our <Link to="/contact">contact page</Link>
            </p>{" "}
          </div>
          <p className="font-text mb-3">Effective as of December 31, 2024</p>
        </div>
      </section>
    </>
  );
